        ...
        <div className="space-y-3">
          {mockProjects.map((project) => (
            <Link key={project.id} href={`/freelancer/projects/${project.id}`}>
              <div className="mt-2 p-4 rounded-lg border border-border bg-background hover:bg-muted/30 transition-colors cursor-pointer">
                  ...
                  <div>
                    ...
                    {project.status === "live" ? (
                      ...
                      <span className="text-lg font-bold text-foreground">
                        {project.currentEarnings.toFixed(4)} USDC
                      </span>
                    )}
                  </div>
