    ...
    <Card className="bg-card border border-border shadow-sm">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base font-semibold">Incoming Contract Requests</CardTitle>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-sm text-foreground">{req.projectTitle}</p>
                    <p className="text-xs text-muted-foreground">{req.contractorName}</p>
                  </div>
                </div>
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-medium bg-muted text-muted-foreground">
                  {req.mode === 'agentic' ? <Bot className="w-3 h-3" /> : <Hand className="w-3 h-3" />}
                  {req.mode}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex gap-4 text-xs text-muted-foreground">
                  <span>Budget: <span className="font-semibold text-foreground">{req.budget}</span></span>
                  <span>Duration: <span className="font-semibold text-foreground">{req.duration}</span></span>
                </div>
