...
export const mockProjectDetails: Record<string, ProjectDetail> = {
  "1": {
    ...
    milestones: [
      {
        ...
        status: "completed",
        dueDate: "Jan 20",
        completedDate: "Jan 19",
        approvedBy: "agent",
      },
      {
        id: "m2",
        title: "Wallet Integration Module",
        status: "completed",
        dueDate: "Jan 28",
      ...
      {
        id: "m3",
        title: "Dashboard Charts & Analytics",
        status: "completed",
        dueDate: "Feb 5",
        completedDate: "Feb 5",
        approvedBy: "agent",
    ...
    agenticApprovals: [
      {
        ...
        verdict: "approved",
        reason:
          "Repository structure follows Next.js best practices. CI/CD pipeline configured correctly. TypeScript strict mode enabled. All linting rules pass.",
      ...
      },
      {
        ...
        verdict: "approved",
        reason:
          "WalletConnect and MetaMask integrations tested. Error handling covers edge cases. Session persistence works across page reloads.",
      ...
      },
      {
        ...
        verdict: "approved",
        reason:
          "Recharts integration complete. Real-time data feeds connected. Performance benchmarks met — renders 1000+ data points at 60fps.",
      ...
      },
      {
        ...
        reason:
          "Core swap logic implemented but slippage tolerance UI missing. Price impact warning not shown for swaps >2%. Recommend adding confirmation modal.",
    ...
    agenticComments: [
      {
        ...
        milestoneId: "m1",
        comment:
          "Clean architecture with clear separation of concerns. The modular folder structure will scale well as more features are added.",
      ...
      },
      {
        ...
        milestoneId: "m2",
        comment:
          "Wallet connection flow is smooth. Consider adding a retry mechanism for failed RPC calls to improve reliability on congested networks.",
        category: "suggestion",
      ...
      },
      {
        id: "c3",
        comment:
          "Project is tracking ahead of schedule. 3 of 6 milestones completed before due dates. Current velocity suggests on-time delivery.",
        category: "progress",
      ...
      },
      {
        ...
        milestoneId: "m4",
        comment:
          "The swap router integration uses an outdated API version. This may cause issues when Uniswap V4 rolls out. Recommend upgrading to the latest SDK.",
        category: "risk",
      ...
      },
      {
        ...
        milestoneId: "m4",
        comment:
          "Test coverage for the swap module is at 72%. Target is 85% per project requirements. Missing tests for edge cases: zero-amount swaps, same-token swaps, and insufficient balance.",
        category: "code-quality",
    ...
    activityLog: [
      {
        id: "e1",
        event: "Contract created and signed by both parties",
        timestamp: "Jan 15, 2026 10:30 AM",
        type: "info",
      },
      {
        id: "e2",
        event: "Streaming payout initiated at 0.0002 USDC/sec",
        timestamp: "Jan 15, 2026 10:35 AM",
        type: "success",
      },
      {
        id: "e3",
        event: "Milestone 1 completed — approved by agent (96% confidence)",
        timestamp: "Jan 19, 2026 4:30 PM",
        type: "success",
      },
      {
        id: "e4",
        event: "Milestone 2 completed — approved by agent (93% confidence)",
        timestamp: "Jan 27, 2026 2:15 PM",
        type: "success",
      },
      {
        id: "e5",
        event: "Stream paused for scheduled review",
        timestamp: "Feb 1, 2026 2:00 PM",
        type: "warning",
      },
      {
        id: "e6",
        event: "Stream resumed after review",
        timestamp: "Feb 1, 2026 4:30 PM",
        type: "info",
      },
      {
        id: "e7",
        event: "Milestone 3 completed — approved by agent (91% confidence)",
        timestamp: "Feb 5, 2026 11:45 AM",
        type: "success",
      },
      {
        id: "e8",
        event: "Agent flagged Token Swap Interface for revision",
        timestamp: "Feb 12, 2026 3:00 PM",
        type: "warning",
      },
      {
        id: "e9",
        event: "Agent risk alert: outdated swap router API detected",
        timestamp: "Feb 12, 2026 3:05 PM",
        type: "error",
      },
    ],
  ...
  "2": {
    ...
    milestones: [
      {
        id: "m1",
        title: "Codebase Review & Threat Model",
        status: "completed",
        dueDate: "Jan 28",
        completedDate: "Jan 26",
        approvedBy: "agent",
      },
      {
        id: "m2",
        title: "Automated Analysis (Slither/Mythril)",
        status: "completed",
        dueDate: "Feb 5",
        completedDate: "Feb 4",
        approvedBy: "agent",
      ...
      {
        id: "m4",
        title: "Governance Module Deep Dive",
        status: "pending",
        dueDate: "Feb 28",
        approvedBy: null,
      },
      {
        id: "m5",
        title: "Final Report & Remediation Guide",
        status: "pending",
        dueDate: "Mar 15",
        approvedBy: null,
      },
    ...
    agenticApprovals: [
      {
        ...
        verdict: "approved",
        reason:
          "Threat model document covers all attack surfaces. STRIDE analysis complete. Dependencies catalogued with known CVE check.",
      ...
      },
      {
        ...
        verdict: "approved",
        reason:
          "Both tools run successfully. 14 findings reported with proper severity classification. False positives documented and explained.",
    ...
    agenticComments: [
      {
        ...
        milestoneId: "m1",
        comment:
          "Thorough threat model. The STRIDE categorization helps prioritize the manual review phase.",
        category: "code-quality",
      ...
      },
      {
        id: "c2",
        comment:
          "Audit is on track. The automated tool phase completed a day early, giving extra buffer for the manual assessment.",
        category: "progress",
    ...
    activityLog: [
      {
        id: "e1",
        event: "Audit contract initiated",
        timestamp: "Jan 20, 2026 9:00 AM",
        type: "info",
      },
      {
        id: "e2",
        event: "Streaming payout started at 0.0003 USDC/sec",
        timestamp: "Jan 20, 2026 9:05 AM",
        type: "success",
      },
      {
        id: "e3",
        event: "Milestone 1 completed — approved by agent (94% confidence)",
        timestamp: "Jan 26, 2026 5:00 PM",
        type: "success",
      },
      {
        id: "e4",
        event: "Milestone 2 completed — approved by agent (89% confidence)",
        timestamp: "Feb 4, 2026 3:30 PM",
        type: "success",
      },
    ],
...
export function getProjectDetail(id: string): ProjectDetail | null {
  ...
  try {
    const stored = JSON.parse(
      localStorage.getItem("starcpay_active_projects") ?? "[]",
    );
