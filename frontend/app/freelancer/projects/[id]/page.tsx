...
export default function FreelancerProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-4">
          <Avatar className="w-12 h-12">
            <AvatarFallback className="bg-primary/10 text-primary font-semibold">
              {project.contractorInitials}
            </AvatarFallback>
          </Avatar>
          <div>
            <h1 className="text-2xl font-bold text-foreground tracking-tight">{project.name}</h1>
            <div className="flex items-center gap-3 mt-1">
              <span className="text-sm text-muted-foreground">{project.contractorName}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="gap-1.5"
            onClick={() => {
              console.log('Withdraw Payout:', {
                streamId: project.id,
                amount: project.streamed,
                to: project.freelancerWallet,
              })
            }}
          >
            <Download className="w-3.5 h-3.5" /> Withdraw Payout
          </Button>
        </div>
      </div>
        ...
        <Card className="bg-card border border-border shadow-sm">
          <CardContent className="pt-4 pb-4">
            ...
            {project.status === 'active' ? (
              ...
              <p className="text-lg font-bold">{project.streamed.toFixed(4)} {project.currency}</p>
            )}
          </CardContent>
        </Card>
        <Card className="bg-card border border-border shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold text-foreground">{project.tasksCompleted} / {project.totalTasks}</p>
                </div>
              </div>
              {/* Documents */}
              <Separator />
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-card border border-border shadow-sm">
            ...
            <CardContent className="space-y-4">
              <div className="relative p-4 rounded-lg bg-gradient-to-r from-emerald-500/5 to-primary/5 border border-border">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-center">
                    ...
                    <p className="text-[10px] text-muted-foreground">{project.contractorName}</p>
                  </div>
                  ...
                  <div className="text-center">
                    <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-950/30 flex items-center justify-center mx-auto mb-1">
                      <span className="text-xs font-bold text-emerald-700 dark:text-emerald-400">You</span>
                    </div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Earned / Budget</span>
