...
const activeStreams = [
  {
    id: "1",
    to: "alex_dev",
    project: "DeFi Dashboard Frontend",
  ...
  },
  {
    id: "3",
    to: "raj_ui",
    project: "Governance Portal UI",
    rate: "0.00015 USDC/sec",
    total: 0.78,
    ratePerSec: 0.00015,
    status: "live" as const,
  },
  {
    id: "4",
    to: "mike_api",
    project: "NFT Marketplace API",
    rate: "0.00025 USDC/sec",
    total: 3.12,
    ratePerSec: 0,
    ...
    <div className="p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Manage your outgoing streams and payment history
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="bg-card border border-border shadow-sm">
          <CardContent className="p-5">
            ...
            <p className="text-2xl font-bold text-foreground">45.8 USDC</p>
